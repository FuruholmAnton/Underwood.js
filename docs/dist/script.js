...
$export$1($export$1.P + $export$1.F * require('./_fails-is-regexp')(ENDS_WITH), 'String', {
...
$export$2($export$2.P + $export$2.F * !STRICT, 'Array', {
...
$export$3($export$3.S, 'Array', { isArray: require('./_is-array') });
...
$export$4($export$4.S + $export$4.F, 'Object', { assign: require('./_object-assign') });

// 19.2.3.2 / 15.3.4.5 Function.prototype.bind(thisArg, args...)
var $export$5 = require('./_export');

$export$5($export$5.P, 'Function', { bind: require('./_bind') });
...
$export$8($export$8.P + $export$8.F * require('./_fails-is-regexp')(INCLUDES), 'String', {
...
$export$9($export$9.G + $export$9.W + $export$9.F * !USE_NATIVE, { Promise: $Promise });
require('./_set-to-string-tag')($Promise, PROMISE);
require('./_set-species')(PROMISE);
Wrapper = require('./_core')[PROMISE];

// statics
$export$9($export$9.S + $export$9.F * !USE_NATIVE, PROMISE, {
...
$export$9($export$9.S + $export$9.F * (LIBRARY || !USE_NATIVE), PROMISE, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return promiseResolve(LIBRARY && this === Wrapper ? $Promise : this, x);
  }
});
$export$9($export$9.S + $export$9.F * !(USE_NATIVE && require('./_iter-detect')(function (iter) {
...
function bind(self) {
  ...
  functions.forEach(function (name) {
    if (!self[name]) return console.warn("Method '".concat(name, "' does not exist on ").concat(_typeof(self), ":"), self);
...
var customEvents = {};
function trigger(element, eventString) {
  var event;
...
function () {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      this.initUI(); // Can the function on the main view

      if (typeof this.init === 'function') this.init(); // Add Event listeners

      this.initEvents(); // Add resize listener
    ...
    value: function bindUIElements() {
      this.ui = {}; // Transform ui to elements

      for (var key in this.uiSelectors) {
        if (this.uiSelectors.hasOwnProperty(key)) {
          var selector = this.uiSelectors[key];
    ...
    value: function bindEvents() {
      ...
      // Reset events
      this.unbindEvents(); // Bind events

      for (var key in this.eventsSelectors) {
        if (this.eventsSelectors.hasOwnProperty(key)) {
          var _ret = function () {
            var functionName = _this.eventsSelectors[key];

            var _key$split = key.split(' '),
                _key$split2 = _slicedToArray(_key$split, 2),
                event = _key$split2[0],
                ui = _key$split2[1]; // Allowing clearer syntax


            event = event.replace(/:/gi, ''); // Get the function and bind it to the view

            var func = _this[functionName] ? _this[functionName].bind(_this) : false;
            if (!func) return "continue";

            var target = function () {
              if (!ui) {
                return _this.el;
              } else {
                return _this.ui[ui.replace('@ui.', '')];
              }
            }();
            ...
            if (target) {
              var add = function add(el) {
                ...
                var list = _this.eventsMap.has(el) ? _this.eventsMap.get(el) : [];
                list.push({
                  event: event,
                  func: func
                });

                _this.eventsMap.set(el, list);
              };
    ...
    value: function unbindEvents() {
      this.eventsMap.forEach(function (list, el) {
    ...
    value: function getElementBySelector(selector) {
      if (typeof this.el == 'undefined') return console.warn("can't set find ".concat(selector, " on undefined"), this);
      if (selector instanceof HTMLElement) return selector; // Allow the use of DOM elements in the ui object

      var base = this.el instanceof HTMLElement ? this.el : document.documentElement;

      if (selector.endsWith('[0]') || selector.startsWith('#')) {
        return base.querySelector(selector.replace('[0]', ''));
      } else {
        var nl = base.querySelectorAll(selector);
        var l = nl.length;
        var arr = new Array(l);
    ...
    key: "bind",
    value: function bind$$1() {
      for (var _len = arguments.length, props = new Array(_len), _key = 0; _key < _len; _key++) {
        props[_key] = arguments[_key];
      }

      bind.apply(void 0, [this].concat(props));
    }
    /**
